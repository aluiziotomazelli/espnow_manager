...
NodeStateMachine::NodeStateMachine() : state_(NodeState::UNINITIALIZED) {}

NodeState NodeStateMachine::get_state() const { return state_.load(); }

void NodeStateMachine::reset() { state_.store(NodeState::UNINITIALIZED); }
