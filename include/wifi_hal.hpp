...
public:
    ...
    esp_err_t set_channel(uint8_t channel) override { return esp_wifi_set_channel(channel, WIFI_SECOND_CHAN_NONE); };
    esp_err_t get_channel(uint8_t *channel) override { return esp_wifi_get_channel(channel, nullptr); };
